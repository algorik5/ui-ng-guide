...
@Component({
  selector: 'app-dashboard-server-cpu-trend',
  template: `
...
export class DashboardServerCpuTrendComponent implements OnInit {

  constructor(private chart:AaechartsService,private pubsub:AapubsubService,private logging:AaloggingService) { }

  topicprefix = "hymon.dashboard-server-cpu-trend";//this.topicprefix+".datas"
